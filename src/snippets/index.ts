    ...
    return pdfui
      ...
      .then((page: any) => {
        return page.addAnnot({
          ...
          flags: 4,
          calloutLinePoints: [
            { x: 77.35922330097088, y: 353.32038834951464 },
            { x: 238.41456310679615, y: 397.0262135922331 },
            { x: 253.41456310679615, y: 397.0262135922331 },
          ],
          rect: {
            left: 76.35922330097088,
            top: 408.1262135922331,
            right: 354.5145631067962,
            bottom: 352.32038834951464,
          },
          innerRect: {
            left: 253.51456310679615,
            top: 407.1262135922331,
            right: 353.5145631067962,
            bottom: 387.1262135922331,
          },
        });
      });
  });
...
export function markAndRedactAStringOfText(pdfui: any, options = {
